...
fc_prefix=f'{namer}/images/flag{flagnum}_cal{calnum}/'
getfit_params=[]
bpgetfit_params=[]
fluxgetfit_params=[]
...
fc_prefix_cal=f'{namer}/images/flag{flagnum}_cal{calnum}/caltables/'
fc_prefix=f'{namer}/images/flag{flagnum}_cal{calnum}/'
...
for iflux in fluxfields:
    ...
    for ibp in bpfields:
        ...
        for itc_match in tc_match:
            ...
            breaker1=0
            if chooser==True:
                if science_field==choose_science:
                    breaker1=1
            if chooser==False:
                breaker1=1
            if breaker1==0:
...
iter_dir = f"{namer}/images/nitercal_{sciniter}"
src_dir = f"{namer}/images/flag{flagnum}_cal{calnum}"
